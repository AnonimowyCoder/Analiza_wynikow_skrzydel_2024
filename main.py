...
def main():
    ...
    # plotter_EPPLER908_CFD.plot_cl_cd_at_target_velocity_compare_foils(8, data_manager_NACA6409_CFD)
    # plotter_EPPLER908_CFD.plot_cl_cd_at_target_velocities({6, 6.5, 7, 7.5})
    # plotter_EPPLER908_CFD.plot_lift_coefficient_at_target_velocity_compare_foils(8, data_manager_NACA6409_CFD)
